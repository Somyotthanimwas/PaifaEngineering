    ...
    <div className="min-h-screen overflow-hidden bg-[#f3f5f6] text-[#10202d]">
      ...
      >
        <div className="container flex h-[76px] items-center justify-between">
          ...
          >
            <a className="nav-link !text-[18px] text-orange-700 hover:text--orange-500" href="#about">
              เกี่ยวกับเรา
            </a>
            <a className="nav-link !text-[18px]  text-blue-700 hover:text-orange-500" href="#services">
              บริการ
            </a>
            <a className="nav-link !text-[18px]  text-orange-700 hover:text-orange-500" href="#projects">
              งานที่เราดูแล
            </a>
            <a className="nav-link !text-[18px]  text-orange-700 hover:text-orange-500" href="#process">
              แนวทางการทำงาน
            </a>
            <a
