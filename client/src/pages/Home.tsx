...
const services = [
  {
    ...
    description:
      "ออกแบบและติดตั้งระบบไฟฟ้า รวมถึงงานรับเหมาระบบไฟฟ้า ติดตั้งหม้อแปลงไฟฟ้า MDB ตู้จ่ายไฟ ระบบไฟฟ้าแรงต่ำ Cable Tray, Bus Duct และ Wiring สำหรับอาคาร โรงงาน และโครงการต่าง ๆ",
  ...
  },
  {
    ...
    description:
      "วางแผน สำรวจและประเมินหน้างาน ออกแบบระบบไฟฟ้าและแนวทางงานวิศวกรรม ประสานงานติดตั้ง ควบคุมคุณภาพ และตรวจสอบระบบให้เหมาะกับการใช้งานและเงื่อนไขของโครงการ",
  ...
  },
  {
    ...
    description:
      "สนับสนุนงานระบบสำหรับโครงการอย่างเป็นระบบ ตั้งแต่ประเมินราคา ประสานงาน ควบคุมงาน ไปจนถึงตรวจสอบและส่งมอบ",
